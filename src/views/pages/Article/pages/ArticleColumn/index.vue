<template>
  ...
  <div v-if="formDialogProps.visible">
    <ColumnDialog :visible="formDialogProps.visible" :opt-type="formDialogProps.optType" :row="formDialogProps.row"
      @change-success="filterDataListHandler" @close="closeDialog"></ColumnDialog>
  </div>
</template>
