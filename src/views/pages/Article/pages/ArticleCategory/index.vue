<template>
  <div class="article-category wh-full">
    <AppSearchPanel :data-exist="categoryList.length > 0" :loading="loading" hide-bottom>
      ...
      <div class="p-4">
        <el-table :data="categoryList" style="width: 100%" row-key="id" size="large" border stripe default-expand-all>
  ...
  <div v-if="formDialogProps.visible">
    <CategoryDialog :visible="formDialogProps.visible" :opt-type="formDialogProps.optType" :row="formDialogProps.row"
      @change-success="getCategoryTree" @close="closeDialog"></CategoryDialog>
  </div>
</template>
