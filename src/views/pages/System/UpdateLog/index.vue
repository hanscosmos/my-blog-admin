<template>
  <div class="wh-full">
      ...
      <template #header>
        <div class="flex items-center justify-between">
          <div class="flex items-center">
            <app-tag size="large" class="mr-4">关键字</app-tag>
    ...
    <div v-if="formDialogProps.visible">
      <UpdateLogFormDialog :opt-type="formDialogProps.optType" :visible="formDialogProps.visible"
        :row="formDialogProps.row" :status-list="statusList" :released-type-list="releaseTypeList" @close="closeDialog"
        @change-success="filterDataListHandler"></UpdateLogFormDialog>
    </div>
  </div>
</template>
