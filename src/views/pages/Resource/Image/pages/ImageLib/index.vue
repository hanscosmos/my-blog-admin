  ...
  <div class="flex flex-col wh-full">
    <div class="header-wrapper border-bottom p-4 flex justify-between items-center">
      <div class="flex items-center">
        ...
        <app-button v-perm="'resource:image:add'" @click="openDialog('add')">
    ...
    <div v-if="formDialogProps.visible">
      <ImageFormDialog :visible="formDialogProps.visible" :opt-type="formDialogProps.optType" :row="formDialogProps.row"
